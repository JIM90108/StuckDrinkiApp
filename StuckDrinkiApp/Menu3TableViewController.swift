...
import UIKit
private let cellID = "Menu3TableViewCell"

class Menu3TableViewController: UITableViewController {
    
    var menuData : Array<Record> = []
    
    let urlStr = "https://api.airtable.com/v0/app2nxltVKfAsfrE5/Menu3?sort[][field]=sort"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! Menu3TableViewCell
